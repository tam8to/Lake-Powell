...
Cisco, Green, and Bluff represent boundary conditions for Lake Powell and are the three major tributaries to Lake Powell (Green and Colorado merge before entering Lake Powell but these sites have long term monitoring data available). Lees is approximately 25 km below the dam and measures what is coming out of the lake. Colorado is a site within Grand Canyon and provides an approximation of any biogeochemical processing that might be occuring within the river istself.

### Data collection and analysis

Data are publicly available and can be download through NWIS (https://nwis.waterdata.usgs.gov/usa/nwis/qwdata) for each of the five sites. Environmental parameters that were monitored continuously across all sites for at least 10 years prior to dam construction were selected. Further criteria and and determination of which of the intial 936 parameters were excluded from the analysis and additional details and work for cleaning and tidying up data can be found at https://github.com/tam8to/Lake-Powell. 
...
Although these preliminary results suggest changes in parameter across sites might be due to dam construction, further analyses must be conducted to attribute these differences to dam construction and additional parameters should also be investigated. The preliminary analyses of this project serve to provide a first pass of available data and help decide furture decisions on which parameters to focus on and how best to continue analyzing this long term data set. Current next steps include time-series analysis.
